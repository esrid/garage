...
func NewFollowUpTool(service *followup.Service, authenticator *voice.TokenAuthenticator) *FollowUpTool {
...
func (h *FollowUpTool) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	ctx, tenantID, err := voice.DecodeToolRequest(w, r, h.authenticator, maxFollowUpBodyBytes, &input)
	if err != nil {
