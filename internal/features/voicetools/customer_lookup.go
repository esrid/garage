...
func NewCustomerLookup(customers *customer.Service, authenticator *voice.TokenAuthenticator) *CustomerLookup {
...
func (h *CustomerLookup) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	ctx, tenantID, err := voice.DecodeToolRequest(w, r, h.authenticator, maxLookupBodyBytes, &input)
	if err != nil {
